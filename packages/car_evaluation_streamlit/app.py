...
st.write(
    "The model evaluates a cars acceptability based on the inputs below.\
        Pass the appropriate details about your car using the questions below \
        to discover if your car is acceptable."
)
...
if st.button("Submit"):
    ...
    response = requests.post(f"http://host.docker.internal:8081/api/v1/predict/",
